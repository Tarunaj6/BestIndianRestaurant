...
class _ListingDetailState extends State<ListingDetail> {
  ...
  _reservation(restaurantName, restaurantOwnerEmail, restaurantId, displayName,
      photoURl, email) {
    print("reservation");
...
// get the data fromreview
    ...
    _buildReservationHtml(String restaurantName, String restaurantOwnerEmail,
        String restaurantId) {
      if (currentUser != null) {
        if (restaurantOwnerEmail == currentUser.email) return Container();
      }
                            ...
                            return new AlertDialog(
                              ...
                              content: new SingleChildScrollView(
                                child: new ListBody(
                                  children: <Widget>[
                                    new Text(
                                        'To Reserve Table Please Login first !'),
                                  ],
                                ),
                              ),
                              actions: <Widget>[
